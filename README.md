...
## Proprietary Code
All code and assets in the following directories are proprietary and licensed under LICENSE-PROPRIETARY.txt:
- `app/`
- `core/`
- `data/`
- `database/`
...
- All resources in `res/` directories

Copyright (c) 2025 Mateo Echavarría / 2wiks - All Rights Reserved.

## Third-Party Components (Apache-2.0)
The following components are third-party works licensed under the Apache License 2.0:
- Gradle Wrapper scripts (`gradlew`, `gradlew.bat`)
  - Copyright 2015 the original author or authors.
  - Licensed under the Apache License, Version 2.0
  - See: https://www.apache.org/licenses/LICENSE-2.0

For details, see the `NOTICE` file in the root directory.
