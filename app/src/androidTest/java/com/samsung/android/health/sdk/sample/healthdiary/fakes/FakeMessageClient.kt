...
/**
 * Simple fake for MessageClient - does not implement full interface.
 * Use this for basic message tracking in tests.
 */
class FakeMessageClient(
     ...
     */
    suspend fun simulateReceive(path: String, data: ByteArray, sourceNodeId: String = "test-node") {
